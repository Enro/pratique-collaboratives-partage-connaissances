...
## Obsidian (avec Dataview) et Notion / Anytype permettent de manipuler des données structurées
<br />
...
Qu'est-ce qiue vous connaissez ?
...
Se connecter sur https://s.42l.fr/airtable_2024
...
#### 1. Retournez à l'accueil https://airtable.com et cliquez sur `r icons::fontawesome("plus")` `Créer` > `Démarrer de zéro` puis donnez à votre base le nom `Recettes MonPrénom`
...
L'objet de cette table sera donc des menus pour une semaine.
...
La table "Recettes" vient d'être créée.
...
A améliorer : ajouter une diapo avec le schéma de la base
...
#### 1. Retournez à l'accueil https://airtable.com et cliquez sur `r icons::fontawesome("plus")` `Créer` > `Démarrer de zéro` puis donnez à votre base le nom `IRD MonPrénom`

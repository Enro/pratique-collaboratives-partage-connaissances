...
## Une base Airtable de la promo 2020/2021 de la Licence professionnelle Médiations de l’information numérique et des données (LP MIND)

[.center[<img src="img/Airtable_annotation_dgf.png" width="600">]](https://airtable.com/appeyi0431fV4OJn4/shrbxFxbTf88iHqCR)

Jeu de données publié sur https://www.data.gouv.fr/fr/datasets/annotation-des-discussions-publiees-sur-data-gouv-fr/ et qui a eu les honneurs de la comm' de data.gouv.fr&nbsp;: https://www.data.gouv.fr/fr/posts/que-se-dit-il-dans-les-commentaires-sur-data-gouv-fr/

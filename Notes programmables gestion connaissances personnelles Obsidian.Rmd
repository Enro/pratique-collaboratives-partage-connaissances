...
--
1. Créer deux notes dans le dossier Notes :
  * Obsidian
  * Basecamp

--
2. Compléter ces notes en rédigeant quelques lignes sur chacun de ces logiciels. La .inverse[syntaxe markdown] est un langage de balisage léger – voir le tuto préparé par Olivier : https://github.com/oledeuff/BUT-Infonum-3/blob/main/Tutoriel%20Markdown.md

--
3. Ajouter des tags sur ces deux notes en cliquant sur `r icons::fontawesome("ellipsis-h")` `Add file property`. 
...
--
1. Tester un modèle : créer une note et cliquer sur l'icône `r icons::fontawesome("copy")` `Insérer le modèle` puis choisir le modèle à appliquer

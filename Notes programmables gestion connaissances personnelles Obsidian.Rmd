...
--
2. Rédiger quelques lignes sur chacun de ces logiciels. La .inverse[syntaxe markdown] est un langage de balisage léger – voir le tuto préparé par Olivier : https://github.com/oledeuff/BUT-Infonum-3/blob/main/Tutoriel%20Markdown.md]

--
3. Ajouter des tags sur ces deux notes.
...
1. Aller dans `Paramètres` > `Modules principaux` > activer le module `Modèles` > cliquer sur la route crantées (`Options`) et définir l'emplacement du dossier modèles comme `Modèles`.

--
2. Recopiez ces trois modèles dans trois notes à placer dans le dossier `Modèles` :
  * UE : ___
  * Cours : _____
  * Devoir : ____

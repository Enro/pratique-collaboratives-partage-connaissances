...
--
#### 2. Créer un nouveau coffre dans un dossier de votre ordinateur

--
#### 3. Créer trois dossiers dans Obsidian :
* Notes
* Modèles
* Images
...
#### 4. Créer deux notes dans le dossier Notes :
* Obsidian
* Basecamp

--

#### 5. Compléter ces notes en rédigeant quelques lignes sur chacun de ces logiciels. La .inverse[syntaxe markdown] est un langage de balisage léger – voir le tuto préparé par Olivier : https://github.com/oledeuff/BUT-Infonum-3/blob/main/Tutoriel%20Markdown.md

--
#### 6. Ajouter des tags sur ces deux notes en cliquant sur `r icons::fontawesome("ellipsis-h")` `Add file property`. 
...
1. Aller dans `Paramètres` > `Modules principaux` > activer le module `Modèles` `r icons::fontawesome("toggle-on")` > cliquer sur `r icons::fontawesome("cog")` pour accéder aux options > définir l'emplacement du dossier modèles comme `Modèles`.

--
2. Télécharger ces trois modèles à placer dans le dossier `Modèles` : https://github.com/Enro/pratiques-collaboratives-partage-connaissances/tree/main/Coffre%20Obsidian/Mod%C3%A8les
  * UE
  * Cours
  * Devoir
...
--
3. Télécharger les notes que j'ai créées à partir de ces modèles, à placer dans le dossier `Notes` : https://github.com/Enro/pratiques-collaboratives-partage-connaissances/tree/main/Coffre%20Obsidian/Notes
...
#### Tutoriel Dataview : https://enro.github.io/pratiques-collaboratives-partage-connaissances/Tutoriel-Dataview.html
...
![Tableau Dataview](img/Tableau Dataview.png)

???

Ouvrir /Users/antoine/Documents/Enseignement/BUT Infonum/Cours "Pratiques collaboratives et partage de connaissances"/Coffre Obsidian/Exercices corrigés Dataview.md dans Obsidian

Les étudiants peuvent consulter 